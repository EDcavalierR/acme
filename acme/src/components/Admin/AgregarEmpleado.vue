<template>
  <div class="container card border-secondary">
      ...
      <hr color="grey">
    <form @submit.prevent="AgregarEmpleado" class="mt-2">
...
name: "AgregarEmpleado",
  ...
  methods: {
    async AgregarEmpleado() {
        console.log(this.empleado.DNI);
        console.log(this.empleado.Nombres);
        console.log(this.empleado.Apellidos);
        console.log(this.empleado.Telefono);
        console.log(this.empleado.Celular);
        console.log(this.empleado.Correo);
        console.log(this.empleado.TipoUsuario);
        console.log(this.empleado.Usuario);
        console.log(this.empleado.Contraseña);
        const empleado = await new Empleado()
        const Empleado = await empleado.save()
    }
  }
}
</script>
